...
class ThirdIntroScreen extends StatefulWidget {
  ...
  @override
  State<ThirdIntroScreen> createState() => _FirstIntroScreenState();
}

class _FirstIntroScreenState extends State<ThirdIntroScreen> {
  @override
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(
                  child: Column(
                      ...
                      children: [
                    Text(translation(context).boost,
                        style: TextStyle(
                            fontSize: 30.sp, fontWeight: FontWeight.w600)),
                    Text(translation(context).productivity,
                        style: TextStyle(
                            fontSize: 30.sp, fontWeight: FontWeight.w600)),
                    SizedBox(height: 5.h),
                    Text(translation(context).connectTools,
                        softWrap: true,
                        style: TextStyle(
