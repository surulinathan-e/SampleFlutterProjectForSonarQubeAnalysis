...
class _FirstIntroScreenState extends State<FirstIntroScreen> {
  ...
  Widget _buildImage() {
    return Center(
        child: Image.asset('assets/images/organize_your_project_intro_image.png',
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(
                child: Column(
                    ...
                    children: [
                  Text(translation(context).organize,
                      style: TextStyle(
                          fontSize: 30.sp, fontWeight: FontWeight.w600)),
                  Text(translation(context).yourProjects,
                      style: TextStyle(
                          fontSize: 30.sp, fontWeight: FontWeight.w600)),
                  SizedBox(height: 5.h),
                  Text(translation(context).simplifyWorkflows,
                      softWrap: true,
                      style: TextStyle(
